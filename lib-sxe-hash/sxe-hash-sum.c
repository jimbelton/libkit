...
/**
 * Override the default hash sum function (xxh128)
 *
 * @param new_hash_128 Pointer to a function that takes a key and a length and a pointer to two uint64_t values
 *
 * @note If the function is passed 0 as the length, it should use strlen to compute the length of the key
 */
SXE_HASH_128_FUNC
